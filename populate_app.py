...
def populate():
    ...
    products = [
        ...
        {'name': 'MTB3',
         ...
         'description': 'bike5',
         'price': 110,
         'picture': 'population_pictures/products/bike5.jpg',
         'seller': 'Ellie3'},
        {'name': 'MTB4',
         'subcategory': 'MTB',
         'description': 'bike6',
         'price': 20,
         'picture': 'population_pictures/products/bike6.jpg',
         'seller': 'Bellie'},
         {'name': 'MTB5',
         'subcategory': 'MTB',
         'description': 'bike9',
         'price': 10,
         'picture': 'population_pictures/products/bike9.jpg',
         'seller': 'Ellie2'},
        {'name': 'MTB6',
         'subcategory': 'MTB',
         'description': 'bike10',
         'price': 21,
         'picture': 'population_pictures/products/bike10.jpg',
         'seller': 'Dellie'},
         # Hybrid bikes
        {'name': 'Hybrid1',
         'subcategory': 'Hybrid',
        ...
        {'name': 'Hybrid3',
         ...
         'description': 'bike7',
         'price': 17,
         'picture': 'population_pictures/products/bike7.jpg',
         'seller': 'Dellie'},
        {'name': 'Hybrid4',
         'subcategory': 'Hybrid',
         'description': 'bike8',
         'price': 60,
         'picture': 'population_pictures/products/bike8.jpg',
         'seller': 'Bellie'},
        {'name': 'Hybrid5',
         'subcategory': 'Hybrid',
         'description': 'bike11',
         'price': 99,
         'picture': 'population_pictures/products/bike11.jpg',
         'seller': 'Dellie'},
        {'name': 'Hybrid6',
         'subcategory': 'Hybrid',
         'description': 'bike12',
         'price': 15,
         'picture': 'population_pictures/products/bike12.jpg',
         'seller': 'Dellie'},
         # Road bikes
        {'name': 'road_bike1',
        ...
        {'name': 'road_bike4',
         ...
         {'name': 'road_bike5',
         'subcategory': 'Road bike',
         'description': 'road_bike5',
         'price': 44,
         'picture': 'population_pictures/products/road_bike5.jpg',
         'seller': 'Kellie2'},
        {'name': 'road_bike6',
         'subcategory': 'Road bike',
         'description': 'road_bike6',
         'price': 17,
         'picture': 'population_pictures/products/road_bike6.jpg',
         'seller': 'Kellie3'},
         # Pedals
        {'name': 'pedal1',
         'subcategory': 'Pedal',
        ...
        {'name': 'pedal4',
         ...
         'description': 'pedal5',
         'price': 11,
         'picture': 'population_pictures/products/pedals5.jpg',
         'seller': 'Ellie'},
         {'name': 'pedal6',
         'subcategory': 'Pedal',
         'description': 'pedal6',
         'price': 12,
         'picture': 'population_pictures/products/pedals6.jpg',
         'seller': 'Kellie'},
         {'name': 'pedal7',
         'subcategory': 'Pedal',
         'description': 'pedal7',
         'price': 13,
         'picture': 'population_pictures/products/pedals7.jpg',
         'seller': 'Bellie'},
         {'name': 'pedal8',
         'subcategory': 'Pedal',
         'description': 'pedal8',
         'price': 14,
         'picture': 'population_pictures/products/pedals8.jpg',
         'seller': 'Dellie'},
         # Handlebars
        {'name': 'handlebars1',
         'subcategory': 'Handles',
        ...
        {'name': 'handlebars4',
         ...
         'description': 'handle5',
         'price': 21,
         'picture': 'population_pictures/products/handlebars5.jpg',
         'seller': 'Ellie3'},
        {'name': 'handlebars6',
         'subcategory': 'Handles',
         'description': 'handle6',
         'price': 31,
         'picture': 'population_pictures/products/handlebars6.jpg',
         'seller': 'Ellie2'},
         {'name': 'handlebars7',
         'subcategory': 'Handles',
         'description': 'handle7',
         'price': 41,
         'picture': 'population_pictures/products/handlebars7.jpg',
         'seller': 'Ellie3'},
        {'name': 'handlebars8',
         'subcategory': 'Handles',
         'description': 'handle8',
         'price': 15,
         'picture': 'population_pictures/products/handlebars8.jpg',
         'seller': 'Ellie2'}]

    # data for product lists
    wishlists = [
        {'username': 'Ellie',
         'products': ['MTB1', 'MTB2', 'MTB3', 'MTB4']},
        {'username': 'Kellie',
         'products': ['pedal1', 'pedal2']},
        {'username': 'Dellie',
         'products': ['road_bike1', 'road_bike2', 'handlebars1']},
        {'username': 'Bellie',
         'products': ['road_bike1', 'Hybrid1', 'handlebars2']}]
